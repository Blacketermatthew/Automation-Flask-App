...
def site24x7_closer(sys_id=""):
    ...
    if r.status_code == 200:
        ...
        data = {'business_service': business_service,
                ...
                'close_notes': 'This alert has cleared in Site24x7.  This ticket was closed using via API.  Please reach out to the CRC if you have any questions or concerns.',
                'incident_state': '6'
                }
